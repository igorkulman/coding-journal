...
I worked at a mobile development company in the Czech Republic at the time so the Czech Microsoft approached us via a developer evangelist to create a Windows 8 "Metro" app for the official launch of Windows 8.
...
In defense of Windows 8 Microsoft made an argument that the platform is not new and not yet mature so it was OK it did not support all the things developers expected from say iOS or even from Win32, saying then when iOS was releases it did not support those things either.
...
He called me multiple times, promised several Windows 8 projects. He never deliver of any of his promises. When I actually needed something from him he just completely ignored me. Not just my but also my clients that I build the apps for.
...
The graphic designer was definitely an iOS user because the designs for Windows 8 were full of gradients and reflections, created for just one resolution. He probably never was any Windows 8 apps, knew nothing about the "Metro" style.
...
The in-app purchases had a ton of problems at that time and they did not even support crating more than I think 100 separate items so absolutely useless for a magazine with daily new issues. 
